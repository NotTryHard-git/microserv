...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in proto/notification_pb2_grpc.py depends on'
...
class NotificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendNotification = channel.unary_unary(
                ...
                response_deserializer=proto_dot_notification__pb2.NotificationResponse.FromString,
                _registered_method=True)
        self.GetUserNotifications = channel.unary_unary(
                '/notification.NotificationService/GetUserNotifications',
                request_serializer=proto_dot_notification__pb2.UserNotificationsRequest.SerializeToString,
                response_deserializer=proto_dot_notification__pb2.UserNotificationsResponse.FromString,
                _registered_method=True)
...
def add_NotificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendNotification': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=proto_dot_notification__pb2.NotificationResponse.SerializeToString,
            ),
            'GetUserNotifications': grpc.unary_unary_rpc_method_handler(
                    servicer.GetUserNotifications,
                    request_deserializer=proto_dot_notification__pb2.UserNotificationsRequest.FromString,
                    response_serializer=proto_dot_notification__pb2.UserNotificationsResponse.SerializeToString,
            ),
    }
...
class NotificationService(object):
    ...
    def SendNotification(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            proto_dot_notification__pb2.NotificationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetUserNotifications(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/notification.NotificationService/GetUserNotifications',
            proto_dot_notification__pb2.UserNotificationsRequest.SerializeToString,
            proto_dot_notification__pb2.UserNotificationsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
